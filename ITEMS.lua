	...
	global.items = {
		["rpgitems_health_potion"] = {
			...
			func = function(player)
				for i=1, 900 do
					if not global.on_tick[game.tick + i] then global.on_tick[game.tick + i] = {} end
					table.insert(global.on_tick[game.tick + i], { func = function (vars)
		...
		["rpgitems_mana_potion"] = {
			...
			func = function(player)
				for i=1, 30 do
					if not global.on_tick[game.tick + i*30] then global.on_tick[game.tick + i*30] = {} end
					table.insert(global.on_tick[game.tick + i*30],{ func = function (vars)
		...
		["rpgitems_spineripper"] = {
			effects = {	{type = "force", modifier = "ammo_damage_modifier", value = 1},
						{type = "other", modifier = "crit", value = 0.1},
						{type = "other", modifier = "critdamage", value = 0.5, unique = "Spineripper"}},
			name = "[Spineripper]",
			price = 20000,
			parts = {
			{name = "rpgitems_damage_1", count = 1},
		...
		["rpgitems_wind_0"] = {
			effects = {	
				{type = "force", modifier = "gun_speed_modifier", value = 0.3},
				{type = "other", modifier = "crit", value = 0.05},--, unique = "Immolation"},
			},
			name = "[Swift Blade]",
			price = 15000,
			parts = {
				{name = "rpgitems_crit_0", count = 1},
				{name = "rpgitems_attackspeed_0", count = 1},
		...
		["rpgitems_wind_1"] = {
			effects = {	
				{type = "force", modifier = "gun_speed_modifier", value = 0.50},
				{type = "other", modifier = "crit", value = 0.09},
			...
			parts = {
				--{name = "rpgitems_crit_0", count = 1},
				--{name = "rpgitems_crit_1", count = 1},
				{name = "rpgitems_wind_0", count = 1},
				{name = "rpgitems_attackspeed_0", count = 1},
				--{name = "rpgitems_manareg_0", count = 1},
			}
		},
		["rpgitems_lifesteal_0"] = {
			effects = {	{type = "force", modifier = "turret_attack_modifier", value = 0.2, turret = "character"},
		...
		["rpgitems_yellow_ammo"] = {
			effects = {	{type = "force", modifier = "ammo_damage_modifier", value = 0.20, ammo = "bullet"},
						{type = "giveitem", item = "firearm-magazine", per_second = 0.1}},
			name = "[Enchanted Firearm Magazine]",
			price = 20000,
		},
		["rpgitems_red_ammo"] = {
			effects = {	{type = "force", modifier = "ammo_damage_modifier", value = 0.30, ammo = "bullet"},
		...
		["rpgitems_green_ammo"] = {
			effects = {	{type = "force", modifier = "ammo_damage_modifier", value = 0.40, ammo = "bullet"},
		...
		["rpgitems_tyrs_hand"] = {
			effects = {
						...
						{type = "force", modifier = "gun_speed_modifier", value = 0.4},
						{type = "other", modifier = "crit", value = 0.07},
						{type = "force", modifier = "character_health_bonus", value = 250},
					},
			name = "[Týr's Hand]",
			...
			parts = {
				...
				--{name = "rpgitems_crit_0", count = 1},
				{name = "rpgitems_wind_0", count = 1},
				{name = "rpgitems_health_0", count = 1}
			}
		},
		...
		["rpgitems_armor_2"] = {
			effects = {	
						...
						{type = "other", modifier = "armor", value = 45},
						{type = "other", modifier = "regen", value = 5},
			},
			name = "[Steel Plate]",
			price = 13000,
		...
		["rpgitems_bulwark"] = {
			effects = {	
						...
						{type = "other", modifier = "regen", value = 10},
			...
			price = 12000,
			parts = {
			{name = "rpgitems_health_1", count = 1},
			{name = "rpgitems_regeneration_1", count = 1},
		...
		["rpgitems_horned_helmet"] = {
			effects = {	
						...
						{type = "other", modifier = "armor", value = 20},
						{type = "other", modifier = "thorns", value = 90},
					},
			name = "[Horned Helmet]",
			price = 10000,
			parts = {{name = "rpgitems_spiked_collar", count = 1},{name = "rpgitems_armor_health", count = 1},{name = "rpgitems_damage_0", count = 1}}
		},
		...
		["rpgitems_flamecloak_spepa"] = {
			...
			func = function(player)
				...
				if global.immolation[player.index] and player.character and player.character.valid then
					player.surface.create_entity{name = "rpgitems-flamecloak-sticker", position=player.position, target= player.character}
				else
		...
		["rpgitems_crit_1"] = {
			effects = {	
				{type = "force", modifier = "ammo_damage_modifier", value = 0.4},
		...
		["rpgitems_chardamage_gold_reg"] = {
			effects = {	
						...
						{type = "other", modifier = "armor", value = 15},
						{type = "other", modifier = "regen", value = 7.5},
			...
			--description = "\n[color=0.7,0.7,0.7]Melee Damage gets multiplied by item damage bonuses[/color]",
			price = 10000,
			parts = {{name = "rpgitems_chardamage_gold", count = 1},{name = "rpgitems_regeneration_0", count = 1},{name = "rpgitems_armor_0", count = 1}}
		},
		["rpgitems_spellpack_neclace"] = {
			effects = {	{type = "spellpack", modifier = "max_mana", value = 30},
		...
		["rpgitems_multitool"] = {
			...
			price = 12000,
			parts = {
				{name = "rpgitems_mining_speed", count = 1},
				{name = "rpgitems_crafting_speed", count = 1},
			},
		},
		--["rpgitems_book1"] = {
		...
		["rpgitems_rainbow_drill"] = {
			effects = {	{type = "force", modifier = "manual_mining_speed_modifier", value = 2.0},
						{type = "force", modifier = "manual_crafting_speed_modifier", value = 1.0},
			...
			name = "[Ultimate Miner]",
			price = -15000,
			parts = {{name = "rpgitems_steel_plates_generator", count = 1},{name = "rpgitems_iron_plates_generator", count = 1},{name = "rpgitems_copper_plates_generator", count = 1},{name = "rpgitems_stone_bricks_generator", count = 1}},
		},
		["rpgitems_iron_generator"] = {
			effects = {	{type = "force", modifier = "manual_mining_speed_modifier", value = 0.2},
		...
		["rpgitems_iron_plates_generator"] = {
			effects = {	{type = "force", modifier = "manual_mining_speed_modifier", value = 0.4},
						{type = "force", modifier = "manual_crafting_speed_modifier", value = 0.2},
						{type = "giveitem", item = "iron-plate", per_second = 0.5}},
		...
		["rpgitems_steel_plates_generator"] = {
			effects = {	{type = "force", modifier = "manual_mining_speed_modifier", value = 0.8},
		...
		["rpgitems_cards_spepa"] = {
			effects = {	
				...
				{type = "spellpack", modifier = "cdr", value = 0.1},
				{type = "other", modifier = "repair", value = 0.15},
				{type = "other", modifier = "energy", value = 250},
			},
		...
		["rpgitems_spellpack_helmet"] = {
			effects = {	
						...
						{type = "spellpack", modifier = "max_mana", value = 50},
						{type = "spellpack", modifier = "mana_reg", value = 1},
						{type = "spellpack", modifier = "spirit_reg", value = 0.3},
						{type = "spellpack", modifier = "cdr", value = 0.3},
					},
			requires = "spell-pack",
			andversion = 18,
			name = "[Hood of Wisdom]",
			price = 25000,
			parts = {
				{name = "rpgitems_spellpack_neclace", count = 1},
				{name = "rpgitems_grenade_damage_0", count = 1},
			}
		},
		["rpgitems_repair"] = {
		...
		["rpgitems_lavalamp"] = {
			effects = {	
				{type = "force", modifier = "ammo_damage_modifier", value = 0.2, ammo = "flamethrower"},
			},
			name = "[Lava Lamp]",
			stack_size = 10,
			--description = "[color=0.7,0.7,0.7]Stun chance is tripled for player attacks[/color]",
...
function make_description(data)
	...
	for _, effect in pairs(data.effects) do
		...
		elseif effect.type == "giveitem" then
			...
			if effect.per_second ~=1 and localization[effect.item] and (localization[effect.item]:sub(-5,-1)=="plate" or localization[effect.item]:sub(-5,-1)=="brick" or localization[effect.item]:sub(-8,-1)=="magazine") then
				descr=descr.."s"
			end
